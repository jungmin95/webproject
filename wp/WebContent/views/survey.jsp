...
<main>
	...
	<div class="container margin_60">
		...
		<article class="feature">
			<div class="col-md-5">
				<img src="img/servey/me.jpg" class="img-responsive" alt="">
          	</div>
			<div class="content">
				<h3>나는 어떤 사람일까?</h3>
				<p><br>
		...
		<article class="feature right">
			<div class="col-md-5">
				<img src="img/servey/paragliding.jpg" class="img-responsive" alt="" />
			</div>
			<div class="content">
		...
		<article class="feature left" style="text-align:center;">
			...
			<div class="col-md-5">
				<br><img src="img/servey/wine.jpg" class="img-responsive" align="middle" />
				<input id="r3_1" name="r3" type="radio" value="1">와인 한잔<p>
				
			</div>
			<div class="col-md-5">
				<br><img src="img/servey/sunset.jpg" class="img-responsive" />
		...
		<article class="feature right" style="text-align:center;">
			...
			<div class="col-md-5">
				<br><img src="img/servey/surfboard.jpg" class="img-responsive" alt="" />
				<input id="r4_1" name="r4" type="radio" value="1">서핑<p>
				
			</div>
			<div class="col-md-5">
				<br><img src="img/servey/beach.jpg" class="img-responsive" alt="" />
		...
		<article class="feature right" style="text-align:center;">
			...
			<div class="col-md-5">
				<br><img src="img/servey/art.jpg" class="img-responsive" alt="" />
				<input id="r5_1" name="r5" type="radio" value="1">박물관<p>
				
			</div>
			<div class="col-md-5">
				<br><img src="img/servey/city.jpg" class="img-responsive" alt="" />
		...
		<article class="feature right" style="text-align:center;">
			...
			<div class="col-md-5">
				<br><img src="img/servey/food.jpg" class="img-responsive" alt="" />
				<input id="r6_1" name="r6" type="radio" value="1">음식<p>
				
			</div>
			<div class="col-md-5">
				<br><img src="img/servey/photo.jpg" class="img-responsive" alt="" />
		...
		<article class="feature right" style="text-align:center;">
			...
			<div class="col-md-5">
				<br><img src="img/servey/healing.jpg" class="img-responsive" alt="" />
				<input id="r7_1" name="r7" type="radio" value="1">힐링<p>
				
			</div>
			<div class="col-md-5">
				<br><img src="img/servey/party.jpg" class="img-responsive" alt="" />
		...
		<article class="feature right" style="text-align:center;">
			...
			<div class="col-md-5">
				<br><img src="img/servey/history.jpg" class="img-responsive" alt="" />
				<input id="r8_1" name="r8" type="radio" value="1">역사<p>
				
			</div>
			<div class="col-md-5">
				<br><img src="img/servey/food2.jpg" class="img-responsive" alt="" />
