...
<!-- End Slider -->
	...
	<div class="container margin_60">
	    ...
	    <!-- <form action="${pageContext.request.contextPath}/survey/survey.do" method="POST" >-->
		...
		<p class="text-center add_bottom_30">
			<button class="button_drop outline" type="submit" onclick="location.href='${pageContext.request.contextPath}/survey/survey.do?r1=${survey.r1 }'">작성 완료</button>
