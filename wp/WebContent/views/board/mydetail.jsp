			...
			<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="post">
                         ...
                         <a href="${pageContext.request.contextPath}/article/mymodify.do?articleNo=${Article.articleNo}" class="glyphicon glyphicon-cog pull-right" style="padding:10px">수정</a>
...
<%--                          &nbsp;<span class="text-muted">조회 ${Article.viewcount}</span> --%>
            ...
            <div class="text-center">
                <a href="${pageContext.request.contextPath}/article/mylist.do">
