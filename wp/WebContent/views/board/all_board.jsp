	                    		...
	                    		<c:otherwise>
	                    			<c:forEach var="Article" items="${Article}">
				                        <tr>
				                            ...
				                            <td>
				                            	<a href="${pageContext.request.contextPath}/article/read.do?articleNo=${Article.articleNo}">${Article.title}</a>
				                            </td>
...
<%-- 				                            <td class="text-center">${Article.viewcount}</td> --%>
	            ...
	            <div class="text-right">
	                <a href="${pageContext.request.contextPath}/views/board/write.jsp">
